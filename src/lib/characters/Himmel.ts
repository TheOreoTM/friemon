...
import { HOLY_STRIKE, COURAGE_BOOST, HEALING_MAGIC, SHIELD_WALL, SPEED_BOOST } from '../techniques/SharedTechniques';
...
const Himmel = new CharacterData({
	...
	techniques: [HOLY_STRIKE, HEROIC_INSPIRATION, COURAGE_BOOST, HEALING_MAGIC, SHIELD_WALL, SPEED_BOOST],
