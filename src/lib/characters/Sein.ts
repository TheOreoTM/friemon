...
import { GODDESS_BLESSING, HEALING_MAGIC, HOLY_STRIKE, DEFENSIVE_MAGIC } from '../techniques/SharedTechniques';
...
const Sein = new CharacterData({
	...
	races: [Race.Human],
	baseStats: seinStats,
	techniques: [GODDESS_BLESSING, HEALING_MAGIC, HOLY_STRIKE, DEFENSIVE_MAGIC],
	ability: seinAbility,
	additionalMetadata: {
		overheal: true,
		divineBlessing: true
