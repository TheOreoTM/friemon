...
import { DRAGON_SLASH, BERSERKER_RAGE, GUARD_BREAKER } from '../techniques/SharedTechniques';
...
const COWARD_FLEE = new Technique({
	...
	manaCost: 5,
	initiative: 3,
	effects: [createStatBoostEffect('speed', 2, 1.0, EffectTarget.Self), createStatBoostEffect('attack', -1, 1.0, EffectTarget.Self)],
...
const Stark = new CharacterData({
	...
	techniques: [DRAGON_SLASH, RESOLVE_STRIKE, BERSERKER_RAGE, GUARD_BREAKER, COWARD_FLEE],
