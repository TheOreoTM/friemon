...
import { ZOLTRAAK, JUDRADJIM, DEFENSIVE_MAGIC, MANA_SHIELD } from '../techniques/SharedTechniques';
...
const Denken = new CharacterData({
	...
	techniques: [ZOLTRAAK, JUDRADJIM, DEFENSIVE_MAGIC, MANA_SHIELD],
